...
if (!$memberId) {
    die("Použití: php generate_member_qr.php <member_id> [force]\n");
}
...
try {
    ...
    echo "Generuji QR kód pro člena ID: $memberId" . ($force ? " (VYNUCENO)" : "") . "...\n";
    $path = $membersFacade->generateQr($memberId, $force);
