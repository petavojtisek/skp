<?php
/**
 * Install script for Members module (Tool)
 */
...
$moduleId = $moduleFacade->save($module);

// 5. Register Permissions & Rights (using existing ones as requested)
$rights = [
    'list' => 'Výpis',
    'edit' => 'Editace',
    'delete' => 'Mazání',
...
foreach ($rights as $code => $rightName) {
    ...
    if (!$permId) {
        ...
        $permId = $modulePermissionFacade->save($perm);
    }
